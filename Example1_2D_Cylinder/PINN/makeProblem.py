...
def make_problem(args,Data):
    ...
    state = odil.State()
    state.fields['nnet']    = domain.make_neural_net([3] + NN_arch + [3])
    #state.fields['u_net'] = domain.make_neural_net([3] + args.NN_arch + [1])
    #state.fields['v_net'] = domain.make_neural_net([3] + args.NN_arch + [1])
    #state.fields['p_net'] = domain.make_neural_net([3] + args.NN_arch + [1])
